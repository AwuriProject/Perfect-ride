...
const GetStarted = () => {
  return (
    <div className="get__started" id="get-started">
            ...
            <div className="get__started--cards">
              <div className="get__started--card">
                ...
                <div className="get__started--card--title">
                  <h4>Download App</h4>
                  <p>
                    Get the app from your mobile AppStore or Google Playstore.
                  </p>
                </div>
              </div>
              ...
              <div className="get__started--card">
                ...
                <div className="get__started--card--title">
                  ...
                  <p>
                    Sign up as a rider or driver with your phone number— it
                    takes a minute!
                  </p>
                </div>
              </div>
